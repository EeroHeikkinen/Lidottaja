...
<td class=docs>
<div class="span-5">
	<p>Anna tunnus ja salasana. Voit myös testata tällä loginilla:</p>
	<ul>
...
<div class="span-10 append-2 last">
	<c:if test="${not empty param.login_error}">
		<div class="error">
			Kirjautumisesi ei onnistunut, yritä uudelleen.<br /><br />
	...
	<form name="f" action="<c:url value="/loginProcess" />" method="post">
		<fieldset>
			...
			<p>
				<label for="j_username">Käyttäjä:</label>
				<br />
			...
			<p>
				...
				<label for="remember_me">Älä kysy kahteen viikkoon</label>
			</p>
			<script type="text/javascript">
				Spring.addDecoration(new Spring.ElementDecoration({
