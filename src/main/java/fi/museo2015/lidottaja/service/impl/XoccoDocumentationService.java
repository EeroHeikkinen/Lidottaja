...
/**
 * A service for creating the actual HTML documentation for a Mapping. Also
 * handles the supplying of the XML source code. TODO: zip file support
 */
@Service("documentationService")
public class XoccoDocumentationService implements DocumentationService {
	// static Logger log =
	// Logger.getLogger(DocumentationService.class.getName());
